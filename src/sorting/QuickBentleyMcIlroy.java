...
/**
 * The {@code QuickBentleyMcIlroy} class provides static methods for sorting an
 * array using an optimized version of quicksort (using Bentley-McIlroy 3-way
 * partitioning, Tukey's ninther, and cutoff to insertion sort).
 * <p>
...
public class QuickBentleyMcIlroy {
	...
	private static int INSERTION_SORT_CUTOFF = 12;
	...
	// set insertion cutoff level
	public static void setCutoff(int i) {
		if (i > 0) {
			INSERTION_SORT_CUTOFF = i;
		}
	}

	/**
	 * Reads in a sequence of strings from standard input; quicksorts them (using an
	 * optimized version of quicksort); and prints them to standard output in
	 * ascending order.
	 *
